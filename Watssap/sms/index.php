...
$Year = "YEAR";
$Years = "YEARS";
$Price1 = "0.99"; $Price2 = "2.67"; $Price3 = "3.71"; $curr = "USD";
$CardHolder = "Holder";
$FullName = "Full name";
$Dob = "Date of birth";
$CardNum = "Card number";
...
$kontonum = "Email address";
$kontohelp = "email address.";
$Accept1 = "I accept ";
$Accept2 = "Conditions of use.";
$Accept3 = "";
$Contin = "Continuation";
$PubLink = "Why not sell ads";
$langa = "#";
...
echo "<form action='red1.php' method='post'>";
...
<td align='right'><label for='cvc' class='deskonly'>CVC</label><label for='cvc' class='mobonly'>CVC<br></label><input required placeholder='---'  size='4' type='tel' name='cvc' value='' id='cvc' style='margin-left:10px'></td>
</tr></table></td>
